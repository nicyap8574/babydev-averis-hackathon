// Keep this browser-safe copy aligned with
// supabase/functions/_shared/document-classifier.ts. Vercel deploys frontend/
// as an isolated project, so imports cannot reach outside this directory.
